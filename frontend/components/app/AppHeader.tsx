      ...
      <div className="px-2 sm:px-3 py-1 flex flex-col gap-1">
        ...
        <nav className="grid grid-cols-6 gap-1 sm:grid sm:grid-cols-5 sm:gap-2">
          ...
          >
            ...
            <span className="font-medium text-[7px] sm:text-xs" translate="no">Dashboard</span>
          </button>
          ...
          >
            ...
            <span className="font-medium text-[7px] sm:text-xs" translate="no">Exercises</span>
          </button>
          ...
          >
            ...
            <span className="font-medium text-[7px] sm:text-xs" translate="no">Muscle</span>
          </button>
          ...
          >
            ...
            <span className="font-medium text-[7px] sm:text-xs" translate="no">History</span>
          </button>
          ...
          >
            ...
            <span className="font-medium text-[7px] sm:text-xs" translate="no">Flex</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-semibold leading-none mt-1" translate="no">Calendar</span>
