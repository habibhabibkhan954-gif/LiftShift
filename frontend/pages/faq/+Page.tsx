    ...
    >
      <div className="space-y-10">
        ...
        <section>
          ...
          <p className="text-slate-300 leading-relaxed mb-4">
            No. LiftShift does not store your full training history on any LiftShift-owned server. All computation happens locally in your browser using IndexedDB. We never see your sets, reps, or exercise history. For full details, read the <a href={assetPath('privacy/')} className="text-emerald-300 underline">Privacy</a> page.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-300 leading-relaxed mb-4">
            LiftShift supports <strong>Hevy</strong> (via API sync, recommended), <strong>Strong</strong> (via CSV import), and <strong>Lyfta</strong> (via CSV import). You can also combine data from multiple apps into one unified dashboard. See <a href={assetPath('supported-apps/')} className="text-emerald-300 underline">Supported apps</a> for step-by-step import guides.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-300 leading-relaxed mb-4">
            Yes. LiftShift includes a one-click AI-ready export that formats your training data with built-in analysis modules including junk volume audit, structural balance, joint health, program adherence, and more. You can paste the export into any LLM for personalized training insights. See the <a href={assetPath('ai/')} className="text-emerald-300 underline">AI reference</a> page for details.
          </p>
        </section>
        ...
        <div className="rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-4 mt-6">
          <p className="text-slate-300 text-sm">
            Didn&rsquo;t find your answer? Check the <a href={assetPath('how-it-works/')} className="text-emerald-300 underline">How it works</a> guide for deep dives into every feature, or open an issue on <a href="https://github.com/aree6/LiftShift" className="text-emerald-300 underline">GitHub</a>.
          </p>
        </div>
      </div>
    </InfoShell>
