    ...
    >
      <div className="space-y-7">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 text-slate-300 leading-relaxed">
            <li><a href={assetPath('metrics/training-volume/')} className="text-slate-400 hover:text-emerald-300 transition-colors">Training volume</a> \u2014 Total weight moved per workout, per week, and per muscle group, with rolling window comparisons.</li>
            <li><a href={assetPath('metrics/personal-records/')} className="text-slate-400 hover:text-emerald-300 transition-colors">Personal records (PRs)</a> \u2014 All-time bests, 2-month bests, and premature PR detection with drought alerts.</li>
            <li><a href={assetPath('metrics/one-rep-max/')} className="text-slate-400 hover:text-emerald-300 transition-colors">1RM estimates</a> \u2014 Estimated one-rep max for every exercise, updated after each workout.</li>
            <li><a href={assetPath('metrics/muscle-heatmap/')} className="text-slate-400 hover:text-emerald-300 transition-colors">Muscle heatmaps</a> \u2014 Visual breakdown of which muscles your training emphasises, with 7-day rolling windows and volume zone scoring.</li>
