...
const SCHEMA = JSON.stringify({
  ...
  '@type': 'HowTo',
  'name': 'Import Strong Workout Data into LiftShift',
  'description': 'Step-by-step guide to exporting Strong workout data and importing it into LiftShift for analytics.',
});
