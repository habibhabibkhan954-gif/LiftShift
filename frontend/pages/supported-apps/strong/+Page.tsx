    ...
    >
      <div className="space-y-7">
        <div className="rounded-xl border border-white/10 overflow-hidden bg-black/30">
          <img src={assetPath('/images/misc/weeklyset.avif')} alt="LiftShift analytics dashboard with Strong data import" loading="lazy" className="w-full" />
        </div>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 text-slate-300 leading-relaxed">
            <li><a href={assetPath('metrics/training-volume/')} className="text-emerald-300 underline">Training volume</a> \u2014 Weekly and per-muscle volume trends with rolling comparisons.</li>
            <li><a href={assetPath('metrics/personal-records/')} className="text-emerald-300 underline">Personal records (PRs)</a> \u2014 Track your strongest lifts with tiered PR detection.</li>
            <li><a href={assetPath('metrics/one-rep-max/')} className="text-emerald-300 underline">1RM estimates</a> \u2014 Strength trend tracking without max testing.</li>
            <li><a href={assetPath('metrics/muscle-heatmap/')} className="text-emerald-300 underline">Muscle heatmaps</a> \u2014 See exactly which muscles are getting attention and which are being neglected.</li>
