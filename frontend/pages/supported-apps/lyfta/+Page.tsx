    ...
    >
      <div className="space-y-7">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 text-slate-300 leading-relaxed">
            <li><a href={assetPath('metrics/training-volume/')} className="text-emerald-300 underline">Training volume</a> \u2014 Track volume trends across workouts, weeks, and muscle groups.</li>
            <li><a href={assetPath('metrics/personal-records/')} className="text-emerald-300 underline">Personal records (PRs)</a> \u2014 Tiered PR tracking with gold, silver, and premature detection.</li>
            <li><a href={assetPath('metrics/one-rep-max/')} className="text-emerald-300 underline">1RM estimates</a> \u2014 Progressive strength estimates without maxing out.</li>
            <li><a href={assetPath('metrics/muscle-heatmap/')} className="text-emerald-300 underline">Muscle heatmaps</a> \u2014 Visual per-muscle training emphasis with rolling 7-day windows.</li>
