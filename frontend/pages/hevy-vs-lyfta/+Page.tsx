    ...
    >
      <div className="space-y-10">
        <div className="rounded-xl border border-white/10 overflow-hidden bg-black/30">
          <img src={assetPath('/images/misc/weeklyset.avif')} alt="LiftShift unified analytics dashboard combining Hevy and Lyfta data" loading="lazy" className="w-full" />
        </div>
        ...
        <section>
          ...
          <p className="text-slate-300 leading-relaxed mb-4">
            See the <a href={assetPath('how-it-works/')} className="text-emerald-300 underline">How it works</a> guide for a full walkthrough of every feature.
          </p>
        </section>
        ...
        <div className="rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-4 mt-6">
          <p className="text-slate-300 text-sm">
            Ready to see what your training data actually says? <a href={assetPath('/')} className="text-emerald-300 underline">Open the dashboard</a> and connect Hevy or upload a CSV from Strong or Lyfta. It&rsquo;s free and takes under a minute.
          </p>
        </div>
      </div>
    </InfoShell>
