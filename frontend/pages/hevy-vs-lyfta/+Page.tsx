      ...
      <div className="space-y-10">
        ...
        <div className="rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-4 mt-6">
          <p className="text-slate-300 text-sm">
            Ready to see what your training data actually says? <a href={assetPath('/')} className="text-emerald-300/80 hover:text-emerald-400 transition-colors duration-200">Open the dashboard</a> and connect Hevy or upload a CSV from Strong or Lyfta. It&rsquo;s free and takes under a minute.
          </p>
        </div>
      </div>
    </InfoShell>
