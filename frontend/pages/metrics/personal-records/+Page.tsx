      ...
      <div className="space-y-7">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 text-slate-300 leading-relaxed">
            ...
            <li><strong className="text-white">1RM estimate</strong> \u2014 The highest estimated one-rep max for the exercise, derived from any set using the Epley formula. Even if the weight itself isn\u2019t your heaviest, a set with more reps at a slightly lower weight may produce a higher estimated 1RM. See the <a href={assetPath('metrics/one-rep-max/')} className="text-gray-400 hover:text-emerald-300 transition-all duration-200">1RM page</a> for the formula.</li>
