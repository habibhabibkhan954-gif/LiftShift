    ...
    >
      <div className="space-y-10">
        <div className="rounded-xl border border-white/10 overflow-hidden bg-black/30">
          <img src={assetPath('/images/misc/weeklyset.avif')} alt="LiftShift workout analytics dashboard overview" loading="lazy" className="w-full" />
        </div>

        <section>
          <h2 className="text-lg font-semibold text-white mb-3">Open source</h2>
          <p className="text-slate-300 leading-relaxed mb-4">
            LiftShift is fully open source under the <strong>AGPL-3.0</strong> license. The entire codebase is available on <a href="https://github.com/aree6/LiftShift" className="text-emerald-300 underline">GitHub</a>. You can audit the code, run it locally, or contribute. No hidden telemetry, no paywalls, no server-side data collection.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <div><a href={assetPath('how-it-works/')} className="text-emerald-300 underline">/how-it-works/</a></div>
            <div className="text-slate-300"><strong>Privacy model</strong></div>
            <div><a href={assetPath('privacy/')} className="text-emerald-300 underline">/privacy/</a></div>
            <div className="text-slate-300"><strong>Metrics definitions</strong></div>
            <div><a href={assetPath('metrics/')} className="text-emerald-300 underline">/metrics/</a></div>
            <div className="text-slate-300"><strong>FAQ</strong></div>
            <div><a href={assetPath('faq/')} className="text-emerald-300 underline">/faq/</a></div>
          </div>
        </section>
      </div>
    </InfoShell>
